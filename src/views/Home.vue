...
<div class="wrap">
  ...
  <section class="center-draw-dots" @drop="ondropEnd" @dragenter="preventDefault"  @dragover="preventDefault" @dragstart="onStart">
    ...
    <div v-else class="no-image">
      <input type="file" @change="onImportImage" accept="image/*" />
    </div>
    <!-- 右击菜单 -->
    <section class="dotsMenu" v-show="showMenu" ref="dotsMenu">
      <el-menu 
        ...
        <el-menu-item index="5">绑定自定义数据</el-menu-item>
      </el-menu>
    </section>
  </section>
</div>
...
<script>
  export default {
    data() {
      return {
        ...
        list: [
            ...
            {node: `<div class="light">
              <div class="outer-wrap" style="background: radial-gradient(#eee, green);"></div>
              <div class="inner-wrap" style="background: radial-gradient(#eee, green);"></div>
            </div>`},
            {node: `<div class="light">
            ...
            {node: `<div class="light">
              <div class="outer-wrap" style="background: radial-gradient(#eee, red);"></div>
              <div class="inner-wrap" style="background: radial-gradient(#eee, red);"></div>
            </div>`},
            {node: `<div class="light">
              <div class="outer-wrap" style="background: radial-gradient(#eee, blue);"></div>
              <div class="inner-wrap" style="background: radial-gradient(#eee, blue);"></div>
            </div>`},
            {node: `<div class="light">
              <div class="outer-wrap" style="background: radial-gradient(#eee, #fff);"></div>
              <div class="inner-wrap" style="background: radial-gradient(#eee, #fff);"></div>
            </div>`}
        ],
    ...
    methods: {
      ...
      onDragItem() {
          // this.activeElement = event.target.children.cloneNode();
      },
      onStart() {
